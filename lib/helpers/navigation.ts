...
import AsyncStorage from// lib/helpers/navigation.ts - Fixed without NavigationTracker class conflict
...
export type { NavigationEntry, NavigationState, NavigationOptions }; '@react-native-async-storage/async-storage';
import { router } from 'expo-router';
